...
![](media/image1.png){width="6.129166666666666in" height="5.477777777777778in"}
...
$$\text{VR}_{t} = \left( \frac{\text{VN}}{(1\text{.035})^{n}} \right)\text{*Udi}_{t}$$
...
![](media/image2.png){width="6.125in" height="5.013194444444444in"}
